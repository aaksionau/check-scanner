...
public interface IReceiptRepository
{
    ...
    /// <summary>Newest first. Line items are not loaded.</summary>
    Task<IReadOnlyList<Receipt>> GetAllAsync(CancellationToken cancellationToken);

    /// <summary>Newest first, with line items loaded (needed to compute each one's mismatch amount).</summary>
